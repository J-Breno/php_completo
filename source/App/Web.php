...
class Web extends Controller
{
    ...
    public function register(?array $data): void
    {
        if(!empty($data['csrf'])) {
            ...
            if(in_array("", $data)) {
                $json['message'] = $this->message->info("Informe seus dados para criar a sua conta.")->render();
                echo json_encode($json);
                return;
            }
    ...
    public function error(array $data): void
    {
        ...
        switch ($data["errcode"]) {
            ...
            case "manutencao":
                $error->code = "OPS";
                $error->title = "Descupe. Estamos em manutenção!";
            ...
            default:
                ...
                $error->message = "Sentimos muito, mas o conteúdo que você tentou acessar não existe, está indiponível no momento ou foi removido :/";

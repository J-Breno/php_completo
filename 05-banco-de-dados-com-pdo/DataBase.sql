    -- ************************************************************
    -- Full Stack PHP Developer - Base Completa (Corrigida)
    -- ************************************************************

    -- Desabilita checagem de FKs
    SET FOREIGN_KEY_CHECKS = 0;

    -- Dropa tabelas na ordem correta
    ...
    -- =========================================
    -- Criação da tabela user_address
    -- =========================================
    ...
    -- =========================================
    INSERT INTO users_address (user_id, id, street, number, complement) VALUES

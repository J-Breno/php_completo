...
class Email
{
    ...
    public function __construct()
    {
        ...
        $this->mail->isSMTP();
        $this->mail->setLanguage(CONF_MAIL_OPTIONAL_LANG);

        $this->mail->isHTML(CONF_MAIL_OPTIONAL_HTML);
        $this->mail->SMTPAuth = CONF_MAIL_OPTIONAL_AUTH;
        $this->mail->SMTPSecure = CONF_MAIL_OPTIONAL_SECURE;
        $this->mail->CharSet = CONF_MAIL_OPTIONAL_CHARSET;
     ...
     * @return Email
     */
    public function bootsrap(string $subject, string $message, string $toEmail, string $toName): Email
    {
